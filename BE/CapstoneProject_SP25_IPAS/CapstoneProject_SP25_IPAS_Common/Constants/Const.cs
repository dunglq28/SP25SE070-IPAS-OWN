...
namespace CapstoneProject_SP25_IPAS_Common
{
    public static class Const
    {
        ...
        public static int FAIL_GET_FARM_NOT_EXIST_CODE = 204;
        public static string FAIL_GET_FARM_NOT_EXIST_MSG = "Farm Resource not found";
        public static int FAIL_UPDATE_FARM_CODE = 201;
        public static string FAIL_UPDATE_FARM_MSG = "Farm Update faul";
