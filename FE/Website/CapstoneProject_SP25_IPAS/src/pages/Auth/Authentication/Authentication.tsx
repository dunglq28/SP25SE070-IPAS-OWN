      ...
      <div className={style["toggle-container"]}>
        <div className={style.toggle}>
          <div className={`${style["toggle-panel"]} ${style["toggle-left"]}`}>
            ...
            <Button className={style.hidden} onClick={toggleForm}>Sign In</Button>
          </div>
          <div className={`${style["toggle-panel"]} ${style["toggle-right"]}`}>
            <h1>Hi there!</h1>
            <p>Register with your personal details to become an owner to use all of site features</p>
            <Button className={style.hidden} onClick={toggleForm}>Sign Up</Button>
          </div>
        </div>
      </div>
    </div>
